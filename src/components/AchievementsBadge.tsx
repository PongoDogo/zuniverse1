...
import { getAchievementProgress, getWatchStats, WatchStats } from "@/lib/userPreferences";
  ...
  return (
    <>
      ...
      >
        ...
        <span className="text-sm font-medium">{unlockedCount} Achievements</span>
      </motion.button>
            ...
            >
              ...
              <div className="flex items-center justify-between p-4 border-b border-border">
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="text-lg font-bold">Achievements & Stats</h2>
                </div>
                <button
                  onClick={() => setIsOpen(false)}
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {achievements?.unlocked.map((a) => (
                        ...
                        >
                          ...
                          <p className="text-[10px] font-medium mt-1 truncate">{a.title}</p>
                        </motion.div>
                      ))}
                    </div>
                  )}
